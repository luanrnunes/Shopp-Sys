...
public class SellerFormController implements Initializable {
	...
	/*
	 * Observable e uma lista que permite que sejam rastreadas (listen) alteracoes
	 */
	...
	/* Substituido o metodo setSellerService por este. que injeta dois services */
	...
	public void updateFormData() {
		...
		/*
		 * Como o campo que vai receber a informacao do ID espera uma string, e
		 * necessario
		 */
		...
		if (entity.getDepartment() == null) {
			/*Seleciona o primeiro item disponivel no combobox*/
	...
	/*
	 * Carrega o findall do departmentService para a obsevable list, guardada na
	 * variavel obsList
	 */
	public void loadAssociatedObjects() {
		List<Department> list = departmentService.findAll();
		obsList = FXCollections.observableArrayList(list);
		comboBoxDepartment.setItems(obsList); /* Aqui e onde e injetado para o combobox */
	}
